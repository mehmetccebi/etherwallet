...
/* Decrypt Panel */
decrypt_Access              : 'Cüzdanını nasıl açmak istersin? ',
decrypt_Title               : 'Özel anahtarının formatını seç: ',
decrypt_Select              : 'Bir cüzdan seç: ',

/* Add Wallet */
ADD_Label_1                 : 'Ne yapmak istiyorsun? ',
ADD_Radio_1                 : 'Yeni cüzdan oluştur ',
ADD_Radio_2                 : 'Cüzdan dosyayi seç (Keystore / JSON) ',
ADD_Radio_2_alt             : 'Cüzdan dosyayi seç ',
ADD_Radio_2_short           : 'CÜZDAN DOSYAYI SEC... ',
ADD_Radio_3                 : 'Özel anahatarını Yaspıştır/Yaz ',
ADD_Radio_4                 : 'İzlenecek hesap adresi ekle ', /* maybe another word for watch/izlencek --> Takip edilecek? */
...
SENDModal_Content_4         : 'NOT: Eğer token gönderirken bir hata ile karşılaşırsan, büyük olasılıkla token göndermek için gerekli olana yakıt ücreti yetersizdir. Bunun için hesabına eter yüklemen gerekir. Yakıt sadece eter olarak ödenir. ',
SENDModal_No                : 'Hayır, çıkar beni burdan! ',
...
/* Send Transaction */
TRANS_desc                  : 'Eğer Token göndermek istiyorsan,"Token Gönder" sayfasını kullan. ',
...
TRANS_data                  : 'Veri ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : '21000 yakıt kullanan standart bir işlem 0.000441 ETH e mal olur. Biz hizli bir sekilde mayinlanmasi için, 0.000000021 ETH\'dan biraz daha yüksek gaz fiyatini kullaniyoruz. Biz herhangi bir islem ücreti almiyoruz. ',
...
/* Node Switcher */
NODE_Title                  : 'Özel düğümü kur',
NODE_Subtitle               : 'Yerel bir düğüme bağlanmak için...', 'MyEtherWallet.com üzerinden bağlanmak için düğümünüzün HTTPS olması gerekir. Herhangi bir düğüme [download the MyEtherWallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) bağlanabilirsiniz. Veya, [LetsEncrypt](https://letsencrypt.org/) üzerinden ücretsiz SSL sertifikası alın.',             
NODE_Name                   : 'Düğüm Adı',
NODE_Port                   : 'Düğüm Noktası',
NODE_CTA                    : 'Özel düğümü kaydet ve kullan',

/* Contracts */
CONTRACT_Title              : 'İletişim Adresi ',
CONTRACT_Title_2            : 'Mevcut Sözleşmeyi Seç ',
CONTRACT_Json               : 'ABI / JSON Arayüzü ',
CONTRACT_Interact_Title     : 'Okuma / Yazma Sözleşmesi ',
CONTRACT_Interact_CTA       : 'Bir Fonksiyon Seçin ',
CONTRACT_ByteCode           : 'Byte Kodu ',
CONTRACT_Read               : 'OKU ',
CONTRACT_Write              : 'YAZ ',

/* Swap / Exchange */
SWAP_rates                  : "Güncel Fiyatlar ",
SWAP_init_1                 : "Takas etmek istiyorum! Elimdekileri ",
SWAP_init_2                 : " ile  ", // "I want to swap my X ETH for X BTC"
SWAP_init_CTA               : "Hadi Bunu yapalım! ", // or "Continue"
...
SWAP_start_CTA              : "Takası başlat ",
SWAP_ref_num                : "Referans numaranız ",
SWAP_time                   : "Göndermek için kalan süre ",
...
/* Mnemonic */
MNEM_1                      : 'Lütfen etkileşimde bulunmak istediğiniz adresi seçin. ',
